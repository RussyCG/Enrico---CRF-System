...
{
    public abstract class User : Base.Base
    {
        #region Fields
        ...
        /// <summary>
        /// Initialise a user  without an ID
        /// </summary>
        ...
        public User(string UsernameParam, string PasswordParam, DateTime LastActiveParam, bool IsLockedParam, string EmailAddressParam)
            : base()
        {
        ...
        /// <param name="IsLockedParam">True if the user is locked out of the system and not allowed to log in</param>
        /// <param name="EmailAddressParam">Email Address to contact the user</param>
        public User(int IDParam, string UsernameParam, string PasswordParam, DateTime LastActiveParam, bool IsLockedParam, string EmailAddressParam)
            : base(IDParam)
        {
            this.Username = UsernameParam;
            this.Password = PasswordParam;
